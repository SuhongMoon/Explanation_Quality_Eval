...
from utils import CarlaSyncMode, generate_rgb_cam, get_labels, image2numpy
...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self._actor_filter = "vehicle.tesla.model3" # Fix the car
...
def game_loop(args):
    ...
    try:
        ...
        record_cam_transforms = [
            (carla.Transform(carla.Location(x=1.6, z=1.7)), attachment.Rigid), # Center Camera
            (carla.Transform(carla.Location(x=1.6, z=1.7), carla.Rotation(yaw=15)), attachment.Rigid), # Right Camera
            (carla.Transform(carla.Location(x=1.6, z=1.7), carla.Rotation(yaw=-15)), attachment.Rigid)  # Left Camera
        ]
        ...
        npc.create_npcs(args.vehicles, args.walkers)
        ...
        with CarlaSyncMode(world.world, *record_cameras, fps=10) as sync_mode:
            while True:
                ...
                if world.camera_manager.recording:
                    ...
                    labels_dict = get_labels(world.player)
